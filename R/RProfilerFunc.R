...
profile_arithmetic<-function(varInfo,Exp){
  ...
  if(!isNA(leftInfo$size1)&&!isNA(rightInfo$size1))
    check=paste0(check,"||(",leftInfo$size1,"!=",rightInfo$size1,")&&(",leftInfo$size1,"!=1)&&(",rightInfo$size1,"!=1)")
  
  if(!isNA(leftInfo$size2)&&!isNA(rightInfo$size2))
    check=paste0(check,"||(",leftInfo$size2,"!=",rightInfo$size2,")&&(",leftInfo$size2,"!=1)&&(",rightInfo$size2,"!=1)")
...
profile_transpose<-function(varInfo,Exp){
  ...
  ExpInfo=getVarInfo(varInfo,Exp[[2]])$ExpInfo
  size1=ExpInfo$size2
  size2=ExpInfo$size1
  ExpInfo$size1=size1
  ExpInfo$size2=size2
